        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><a href="/vendor/apply" className="hover:text-primary transition-colors">Store Application</a></li>
              <li><a href="/deliveryman/apply" className="hover:text-primary transition-colors">Driver Application</a></li>
            </ul>
          </div>
